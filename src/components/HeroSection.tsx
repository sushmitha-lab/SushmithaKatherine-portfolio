          ...
          <div className={`space-y-5 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="space-y-2">
              <p className="text-base md:text-lg text-muted-foreground max-w-xl leading-relaxed">
                I build Python and SQL-driven data models and analytical tools that turn messy,
                large-scale data into governed, decision-ready systems. Over 4+ years across Amazon,
                Deloitte, and Dell, I've partnered with cross-functional stakeholders to deliver
                quality-controlled solutions that hold up in production.
              </p>
